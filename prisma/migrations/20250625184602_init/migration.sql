...
CREATE TABLE [dbo].[Unit] (
    ...
    [hmUnit] INT NOT NULL CONSTRAINT [Unit_hmUnit_df] DEFAULT 0,
    [kmUnit] INT NOT NULL CONSTRAINT [Unit_kmUnit_df] DEFAULT 0,
    [siteId] INT NOT NULL,
    [location] NVARCHAR(1000),
...
CREATE TABLE [dbo].[UnitTyreAmount] (
    ...
    CONSTRAINT [UnitTyreAmount_amount_key] UNIQUE NONCLUSTERED ([amount])
);
